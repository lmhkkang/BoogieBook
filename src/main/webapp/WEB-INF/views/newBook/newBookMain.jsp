...
<script type="text/javascript">
	function head(){
	$("#ul_center > li:eq(2)").css("background","white");
	$("#ul_center > li:eq(2) > a").css("color","#5e6b9e");
	}
</script>
<body onload="head();">
					...
					<c:set var = "num" value = "${num+1}"/>							
						<div class="interest_body" style="float:left; width: 650px;">
							<div class="interest_img">
								<a href="${root}/book/bookInfo.do?book_id=${newBook.book_id}&page=newBook"><img src="${newBook.img_path}" width="100%" height="100%"></a>
							</div>
							<div class="interest_subject_form">
								<div class="interest_sub">
									<div class="interest_subject">
										...
										<div class="interest_subject2">
											<a href="${root}/book/bookInfo.do?book_id=${newBook.book_id}&page=newBook"><b>${newBook.book_name}</b></a>
										</div>
								...
								<div class="interest_btn">
									<button type="button" class="btn" style="border: 1px solid #5e6b9e;" onclick="javascript:moveToCart2('${root}','${newBook.book_id}','1')">장바구니담기</button>
									<button type="button" class="btn" style="border: 1px solid #5e6b9e;" onclick="javascript:moveToOrderForm2('${root}','${newBook.book_id}','1')">바로구매</button>
								</div>
							</div>
						</div>		
						</div>
