...
<script src="${root}/resources/javascript/member/KaKaoEdit_js.js"></script>
...
<div class="container" style="border: 0px solid red; margin: 0px auto; height: 500px; margin-left: 105px; margin-bottom: 250px;">
    ...
    <div class="col-md-8" style="width: 1000px; height: 700px; margin: 0px auto;">  
        ...
        <hr>
        <form class="form-horizontal" action="${root}/member/KaKaoEditOk.do" method="get" name="signup" id="signup" enctype="multipart/form-data"
        ...
        <div class="form-group">
          <div class="col-xs-offset-3 col-xs-10" style="padding-left: 140px; padding-top: 30px;">
            ...
            style="width: 130px; height: 40px; background-color: #5e6b9e;" onclick="KaKaoWithdrawal(${id})"/>
          </div> 
        </div>
      </form>
    </div>
