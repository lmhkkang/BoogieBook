...
<div class="container" style="border: 0px solid blue; margin: 0px auto; height:400px; margin-top:50px; margin-left: 120px;">
    ...
    <div class="col-md-8" style="width: 1000px; height: 700px; margin: 0px auto;">  
        ...
        <div class="form-group">
          ...
          <div class="col-md-5 col-sm-8">
            <div class="input-group">
              ...
              <input type="password" style="width: 350px" class="form-control" name="password" id="password" placeholder="비밀번호를 입력하세요." value="" oninput="checkPassword()">
           </div>   
        ...
        <div class="form-group">
          ...
          <div class="col-xs-8">
            <div class="form-inline" style="width: 360px">
              ...
              <div class="form-group">
                <select name="yyyy" class="form-control" style="width: 90px;" >
              ...
              <div class="form-group">
                <select name="mm" class="form-control" style="width: 80px;">
              ...
              <div class="form-group">
                <select name="dd" class="form-control" style="width: 80px;">
        ...
        <div class="form-group">
          <label class="control-label col-sm-3">휴대폰번호 <span class="text-danger">*</span></label>
          <div class="col-md-5 col-sm-8">
          	<div class="input-group">
